...
#[hdk_extern]
pub fn get_commitment_for_offer(offer_hash: ActionHash) -> ExternResult<Vec<Record>> {
    let links = get_links(offer_hash, LinkTypes::OfferToCommitment, None)?;
